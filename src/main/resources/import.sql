...
INSERT INTO users (email, first_name, last_name, registered_at, password) VALUES('utente@email.com', 'Utente', '4', '2023-11-20 16:00', '{noop}utente');
...
INSERT INTO db_photo.photos(description, Title, Url, visible)VALUES('La gioconda',  'Luvre, Paris','https://www.arte.it/foto/600x450/fd/105247-Gioconda_copia_del_Museo_del_Prado_restaurada_.jpg', true);
...
INSERT INTO photos_categories (photos_id, categories_id)VALUES(7,2)
INSERT INTO photos_categories (photos_id, categories_id)VALUES(8,4)